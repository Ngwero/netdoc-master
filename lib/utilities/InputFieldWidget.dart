...
class InputFieldWidget extends StatelessWidget {
  InputFieldWidget({required this.hintText, required this.onTypingFunction, required this.keyboardType, required this.labelText , this.passwordType = false, this.controller= '', this.leftPadding = 20,  this.rightPadding = 20, this.ringColor = kFontGreyColor, this.hintTextColor = Colors.grey, this.labelTextColor = Colors.grey, required this.onFinishedTypingFunction,  this.readOnlyVariable = false  });
