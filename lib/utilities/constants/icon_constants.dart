...
const  kIconBlackout = Icon(CupertinoIcons.calendar_badge_minus, color: kAppGreenColor,size: kIconSize);
...
const kIconClockClose =  Icon(Iconsax.clock,color: kAppGreenColor,size: kIconSize);
...
const kIconPen =  Icon(LineIcons.pen, color: kAppGreenColor,size: kIconSize,);
