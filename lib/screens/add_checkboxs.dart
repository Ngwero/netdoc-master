...
class AddCheckboxes extends StatefulWidget {
  const AddCheckboxes({Key? key}) : super(key: key);

  @override
  State<AddCheckboxes> createState() => _AddCheckboxesState();
}

class _AddCheckboxesState extends State<AddCheckboxes> {
  var serviceName = '';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
            ...
            children: [
              Provider.of<DoctorProvider>(context, listen: false).formCheckboxQuestion == '' ?
              Column(
                children: [

                  Padding(
                    padding: const EdgeInsets.only(top: 15.0, bottom: 15.0),
                    child: Text("New checkbox Question", textAlign: TextAlign.start,
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InputFieldWidget(labelText: ' Checkbox Question',
                          hintText: 'Checkbox question goes here',
                          keyboardType: TextInputType.text,

                          onTypingFunction: (value) {
                            serviceName = value;
                            Provider.of<DoctorProvider>(context, listen: false).setCheckBoxMainQuestion(serviceName);
                ...
                child: Container(
                  child: Text('${Provider.of<DoctorProvider>(context, listen: false).formCheckboxQuestion}',
              ...
              ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: Provider.of<DoctorProvider>(context, listen: false).formCheckboxAnswers.length,
                  itemBuilder: (context, i){
                    return
                      OrderedContentsWidget(
                        ...
                        productName: Provider.of<DoctorProvider>(context, listen: false).formCheckboxAnswers[i],
                      );
                  }),
              kLargeHeightSpacing,
              kLargeHeightSpacing,
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Provider.of<DoctorProvider>(context, listen: false).setUploadCheckboxes(ConditionQuestion(
                      answers: Provider.of<DoctorProvider>(context, listen: false).formCheckboxAnswers.join(", "),

                      question: Provider.of<DoctorProvider>(context, listen: false).formCheckboxQuestion));
                  Navigator.pop(context);
                },
