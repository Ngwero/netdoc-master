...
class FlutterwaveTest extends StatefulWidget {
  FlutterwaveTest(this.title);

  final String title;

  @override
  _FlutterwaveTestState createState() => _FlutterwaveTestState();
}

class _FlutterwaveTestState extends State<FlutterwaveTest> {
  ...
  _handlePaymentInitialization() async {
    final Customer customer = Customer(email: "customer@customer.com", name: 'Bernard', phoneNumber: '0700457826');
