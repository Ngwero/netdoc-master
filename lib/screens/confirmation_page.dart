...
import '../utilities/InputFieldWidget2.dart';
...
class _ConfirmationPageState extends State<ConfirmationPage> {
  ...
  void defaultInitialisation() async{
    ...
    kin = prefs.getString(kNextOfKin)??" ";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Center(child: Text('Confirm Your Information', style: kNormalTextStyleWhiteButtons,)),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InputFieldWidget(readOnlyVariable: true, controller: fullName, labelText:' Display Name' ,hintText: 'Fred Okiror', keyboardType: TextInputType.text, onTypingFunction: (value){
                      fullName = value;
                      firstName = fullName.split(" ")[0]; // Gets the first name in the 0 positiion from the full names
                    }, onFinishedTypingFunction: () {  },),
                    InputFieldWidget(labelText: ' Mobile Number (+2567xxxxxx)',  controller: phoneNumber,hintText: '+25677100100', keyboardType: TextInputType.number,
                    ...
                    InputFieldWidget2(labelText: ' Weight (kg)',controller: weight.toString(),readOnlyVariable: false, hintText: '85', keyboardType: TextInputType.number, onTypingFunction: (value){
                      weight = double.parse(value) ;
                    }, onFinishedTypingFunction: () {  },),
                    InputFieldWidget2(labelText: ' Height (cm)', hintText: '170',controller: height.toString(),readOnlyVariable: false, keyboardType: TextInputType.number, onTypingFunction: (value){
                      height = int.parse(value);
                    }, onFinishedTypingFunction: () {  },),
                    InputFieldWidget2(labelText: ' BMI', hintText: '170',controller: bmi.toString(),readOnlyVariable: true, keyboardType: TextInputType.number, onTypingFunction: (value){
                      height = int.parse(value);
                    }, onFinishedTypingFunction: () {  },),
