...
class GeneralDoctorsPage extends StatefulWidget {
  static String id = 'general_doctor_page';

  @override
  _GeneralDoctorsPageState createState() => _GeneralDoctorsPageState();
}

class _GeneralDoctorsPageState extends State<GeneralDoctorsPage> {
  ...
  return Scaffold(
      appBar: AppBar(
        ...
        title: Text("General Practitioners", style: kNormalTextStyle.copyWith(color: kPureWhiteColor),),
        centerTitle: true,
      ),
          ...
          builder: (context, snapshot)
          {
            if(!snapshot.hasData){
              ...
              for( var doc in orders!){
                ...
                conditionList.add(doc['FirstName']);
                staffIdList.add(doc['staffId']);
                      ...
                      Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              Container(
                                 // color: kGreenDarkColorOld,
                                   height: 170,
                                  width: 50,
                                  child: Image.asset("images/doc.png", fit: BoxFit.contain,)),
                              title:Text("Dr. ${conditionList[index]}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14),),
                              subtitle: Text("General Practictioner", style: kNormalTextStyle.copyWith(fontSize: 14),),
                            ...
                            //   child: Text("General Practictioner", style: kNormalTextStyle.copyWith(fontSize: 14),),
                            // ),
