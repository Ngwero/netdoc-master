...
class SpecialistPage extends StatefulWidget {
  static String id = 'specialist_page';
...
class _SpecialistPageState extends State<SpecialistPage> {
  ...
  return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Specialists", style: kNormalTextStyle.copyWith(color: kPureWhiteColor),),
        centerTitle: true,
      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              subtitle: Text("Specialist Doctor", style: kNormalTextStyle.copyWith(fontSize: 14),),
